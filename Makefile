...
Nintendo.FLAGS = -DENABLE_REFLEX_SNES -DSNES_ENABLE_VBOY -DSNES_ENABLE_MULTITAP -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_GAMECUBE -DENABLE_REFLEX_WII
...
#SNES, PCE, N64 (Original), PSX+neGcon+Guncon+Jogcon
Combo4.FLAGS = -DENABLE_REFLEX_SNES -DSNES_ENABLE_VBOY -DENABLE_REFLEX_PCE -DENABLE_REFLEX_N64 -DENABLE_REFLEX_PSX -DGUNCON_FORCE_MODE=3 -DNEGCON_FORCE_MODE=1 -DGUNCON_SUPPORT -DJOGCON_SUPPORT -DNEGCON_SUPPORT -DENABLE_PSX_GENERAL_OLED -DENABLE_PSX_GUNCON_OLED -DENABLE_PSX_JOGCON_OLED
#SNES, NeoGeo, Jaguar, N64 (Scaled), PSX+neGcon+Guncon+Jogcon
Combo5.FLAGS = -DENABLE_REFLEX_SNES -DENABLE_REFLEX_NEOGEO -DENABLE_REFLEX_JAGUAR -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_PSX -DGUNCON_FORCE_MODE=3 -DNEGCON_FORCE_MODE=1 -DGUNCON_SUPPORT -DJOGCON_SUPPORT -DNEGCON_SUPPORT -DENABLE_PSX_GENERAL_OLED -DENABLE_PSX_GUNCON_OLED -DENABLE_PSX_JOGCON_OLED
...
#PCE, 3DO, NeoGeo, Jaguar, N64 (Scaled), GameCube, Wii
Combo8.FLAGS = -DENABLE_REFLEX_PCE -DENABLE_REFLEX_3DO -DENABLE_REFLEX_NEOGEO -DENABLE_REFLEX_JAGUAR -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_GAMECUBE -DENABLE_REFLEX_WII
#NES, SNES, N64 (Scaled), GameCube, Wii, PSX+neGcon
Combo9.FLAGS = -DENABLE_REFLEX_SNES -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_GAMECUBE -DENABLE_REFLEX_WII -DENABLE_REFLEX_PSX -DNEGCON_FORCE_MODE=1 -DNEGCON_SUPPORT -DENABLE_PSX_GENERAL_OLED
#NES, SNES, N64 (Scaled), Wii, PSX+JogCon
Combo10.FLAGS = -DENABLE_REFLEX_SNES -DSNES_ENABLE_VBOY -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_WII -DENABLE_REFLEX_PSX -DENABLE_PSX_GENERAL_OLED -DJOGCON_SUPPORT -DENABLE_PSX_JOGCON_OLED
#NES, SNES, N64 (Scaled), Wii, PSX+GunCon+neGcon
Combo11.FLAGS = -DENABLE_REFLEX_SNES -DSNES_ENABLE_VBOY -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_WII -DENABLE_REFLEX_PSX -DENABLE_PSX_GENERAL_OLED -DGUNCON_SUPPORT -DGUNCON_FORCE_MODE=3 -DENABLE_PSX_GUNCON_OLED -DNEGCON_SUPPORT -DNEGCON_FORCE_MODE=1
#NES, SNES, N64 (Scaled), Saturn, PSX
Combo12.FLAGS = -DENABLE_REFLEX_SNES -DSNES_ENABLE_VBOY -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_SATURN -DENABLE_REFLEX_PSX -DENABLE_PSX_GENERAL_OLED
#Genesis/Saturn, PSX, N64 (Scaled), Wii
Combo13.FLAGS = -DENABLE_REFLEX_SATURN -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_PSX -DENABLE_PSX_GENERAL_OLED -DENABLE_REFLEX_WII
...
Combo15.FLAGS = -DENABLE_REFLEX_SNES -DSNES_ENABLE_VBOY -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_WII -DENABLE_REFLEX_PSX -DJOGCON_SUPPORT -DENABLE_PSX_JOGCON_OLED
#SNES, N64 (Scaled), Wii, PSX+JogCon+neGcon
...
Combo17.FLAGS = -DENABLE_REFLEX_SNES -DSNES_ENABLE_VBOY -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_WII -DENABLE_REFLEX_PSX -DENABLE_PSX_GENERAL_OLED -DNEGCON_SUPPORT -DNEGCON_FORCE_MODE=1
...
#NES, SNES, Genesis, Saturn, N64 (Scaled), NeoGeo
Combo19.FLAGS = -DENABLE_REFLEX_SNES -DSNES_ENABLE_VBOY -DENABLE_REFLEX_SATURN -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_NEOGEO
#PSX+neGcon+Guncon+Jogcon, N64 (Scaled), Wii
Combo20.FLAGS = -DENABLE_REFLEX_PSX -DGUNCON_FORCE_MODE=3 -DNEGCON_FORCE_MODE=1 -DGUNCON_SUPPORT -DJOGCON_SUPPORT -DNEGCON_SUPPORT -DENABLE_PSX_GENERAL_OLED -DENABLE_PSX_GUNCON_OLED -DENABLE_PSX_JOGCON_OLED -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_WII
#Genesis+Saturn, NES+SNES, N64 (Scaled), SMS
Combo21.FLAGS = -DENABLE_REFLEX_SNES -DSNES_ENABLE_VBOY -DENABLE_REFLEX_SATURN -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65 -DENABLE_REFLEX_SMS
#PCE, Genesis+Saturn, PSX, N64 (Scaled)
Combo22.FLAGS = -DENABLE_REFLEX_PCE -DENABLE_REFLEX_SATURN -DENABLE_REFLEX_PSX -DENABLE_PSX_GENERAL_OLED -DENABLE_REFLEX_N64 -DN64_ANALOG_MAX=65
